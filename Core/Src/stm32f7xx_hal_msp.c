...
static void HAL_FMC_MspInit(void){
  ...
  */
  ...
  GPIO_InitStruct.Pin = PSRAM_A0_Pin|PSRAM_A2_Pin|PSRAM_A3_Pin|PSRAM_A4_Pin
                          |PSRAM_A5_Pin|PSRAM_A7_Pin|PSRAM_A6_Pin|PSRAM_A9_Pin
                          |PSRAM_A8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
static void HAL_FMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOF, PSRAM_A0_Pin|PSRAM_A2_Pin|PSRAM_A3_Pin|PSRAM_A4_Pin
                          |PSRAM_A5_Pin|PSRAM_A7_Pin|PSRAM_A6_Pin|PSRAM_A9_Pin
                          |PSRAM_A8_Pin);
