  ...
  //Recieve Data  
    ...
    for (int i = 0; i < 3 ; i++){
      if (HAL_ADC_PollForConversion(&hadc1, 100) == HAL_OK){
        adcValues_raw[i] = HAL_ADC_GetValue(&hadc1);
      }
    }
  HAL_ADC_Stop(&hadc1);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, ARD_D7_GPIO_Pin|GPIO_PIN_4, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ARD_D7_GPIO_Pin PE4 */
  GPIO_InitStruct.Pin = ARD_D7_GPIO_Pin|GPIO_PIN_4;
